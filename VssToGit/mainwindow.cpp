...
void MainWindow::editFile()
{
    ...
    /*
     * IMPORTANT !!!
     * DO NOT CHANGE the outfile.txt fileName
     * because it's generated by the Git_DLL
     * in the getFile function
     * */

    //string fName = "outfile.txt"

    //    QFile editFile(fName);
    //    QTextStream out(&editFile);
    //    out << QString::fromStdString(fileContent);
    // this part for the choosed file

    //  QFile::copy(filePath),
    //    ofstream editFile(fName);
    //    editFile << fileContent;
    //    qDebug() <<"before opening notepad " ;
    //    QDesktopServices::openUrl(QString::fromStdString(fName));
    //    qDebug() <<"after opening notepad " ;
    //    editFile.close();

//    EditDialog *dialog = new EditDialog();
//    dialog->setContent(fileContent,name);
//    dialog->show();
//    connect(dialog, SIGNAL(textChanged()),this,SLOT(askForCheckIn()));
